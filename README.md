...
Olá! Sou **Gabriel Maia**, estudante de Ciência da Computação na UFABC, com foco em **Data Science**, **Machine Learning** e **Inteligência Artificial**.

Tenho me dedicado a construir uma base sólida em análise de dados, modelagem preditiva e aplicações de IA. Atualmente buscando minha primeira oportunidade profissional na área!

- 🎓 Cursando **Ciência da Computação** — UFABC
- 🌱 Atualmente estudando: **Data Science e Machine Learning**
- 🔭 Trabalhando em projetos de: *Redes Neurais*
- 📫 Contato: **gabrielmaia.p22@gmail.com**
...
> Confira os repositórios fixados abaixo ↓ ou explore todos os projetos na aba **Repositories**.
...
| Projeto em andamento 🔨 - Churn Prediction| Previsão de churns e segmentação de clientes | `MLFlow` `Streamlit` `Python` |
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://linkedin.com/in/gabriel-maia-342318317/)
[![Gmail](https://img.shields.io/badge/Gmail-EA4335?style=for-the-badge&logo=gmail&logoColor=white)](mailto:gabrielmaia.p22@gmail.com)
